...
class WickReversalV4Strategy(StrategyBase):
    ...
    long_min_fee_cover_ratio : float = 5
    ...
    # long_rr_wick_a: float = 4.5                   # A 級 RR
    # long_rr_wick_b: float = 2.5                    # B 級 RR
    # long_rr_wick_c: float = 1.0                     # C 級 RR
    long_rr_wick_a: float = 1                     # A 級 RR
    long_rr_wick_b: float = 1                     # B 級 RR
    long_rr_wick_c: float = 1                     # C 級 RR
    # ── 做空參數（鏡像）──────────────────────────────────────────────────────
    enable_short: bool = True                       # 啟用做空
    short_zoom_bars: int = 1                         # k0 後允許進場的最大觀察根數
    short_sl_offset: float = 2.0                   # 固定停損位移
    short_rr_ratio: float = 1.0                     # 盈虧比
    short_td_consec_bars: int = 2                   # 連續反向 delta 才觸發 TD
    # short_k0_vol_gate: float = 300               # k0 最低成交量門檻
    short_k0_vol_gate: float = 1500
    ...
    short_min_fee_cover_ratio: float = 7
    ...
    # short_rr_wick_a: float = 3                   # A 級 RR
    # short_rr_wick_b: float = 2.5                    # B 級 RR
    # short_rr_wick_c: float = 1                    # C 級 RR
    short_rr_wick_a: float = 1                   # A 級 RR
    short_rr_wick_b: float = 1                    # B 級 RR
    short_rr_wick_c: float = 2                    # C 級 RR
    # ── S4B 專屬 filter ───────────────────────────────────────────────────
